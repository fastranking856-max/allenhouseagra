...
<head>
    ...
    <title>Events | AllenHouse Agra</title>
    <link rel="canonical" href="https://allenhouseAgra.com/event" />
    ...
    <?php include "includes/foot.php" ?>
     ...
     <script>
        ...
        function renderEvents(data) {
            ...
            if (data.length === 0) {
                container.innerHTML = '<p class="text-center text-gray-500 col-span-full py-20">No events found for Agra campus.</p>';
                return;
            }
