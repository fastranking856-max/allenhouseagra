...
<head>
    ...
    <title>AllenHouse Agra | Photo Gallery</title>
...
$data = $photo_gallery_data;

if (!$data || $data['status'] !== 'success') {
    echo "<div class='py-20 text-center'>Failed to fetch gallery data.</div>";
    exit;
}
