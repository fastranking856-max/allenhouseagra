...
<head>
    ...
    <link rel="canonical" href="https://allenhouseagra.com/our-story" />
        ...
        <div class="main relative mb-[40px] sm:mb-[120px]">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="our-story" class="ms-1 sm:text-sm text-xs font-medium text-blue-main">
                                Our Story
                            </a>
                        </div>
                    </li>
            ...
            <div class="mt-8 mx-3 2xl:w-[1280px] lg:w-[1024px] md:w-[767px] sm:w-[640px] sm:mx-auto sm:px-5 px-3">
                <div class="mt-10 relative">
                    <?php
                    // $our_story_data already processed hai apis.php mein
                    // cmsLegacyHtmlPageBlock section index 1 = second section (content wala)
                    if (!empty($our_story_data['description'])) {
                        echo $our_story_data['description'];
                    } elseif (!empty($our_story_data['content'])) {
                        echo $our_story_data['content'];
                    } else {
                        // Fallback: raw sections se directly fetch karo
                        $sections = $our_story_page['data']['sections'] ?? [];
