...
<head>
    ...
    <title>AllenHouse Agra | General Information</title>
                        ...
                        <?php
                            if ($data && $data['status'] === 'success' && isset($data['data'])) {
                                ...
                                foreach ($data['data'] as $row) {
                                    ...
                                    echo '<td class="px-6 py-2">' . htmlspecialchars($row['information']) . '</td>';

                                    // Make email clickable
                                    if (stripos($row['information'], 'mail') !== false) {
                                        $email = htmlspecialchars($row['details']);
