...
<head>
    ...
    <title>AllenHouse Agra| Parent Teacher Association</title>
         ...
         <div class="bg-center flex items-center text-left h-[300px] comman-banner">
            ...
            <div class="md:w-[100%]">
                <h2 class="sm:text-[32px] sm:block hidden font-[700] text-white text-left sm:mb-1 hr-line relative leading-9 ml-[7rem]">
                    Parent 
                    <span class="sm:hidden"></span> Teacher Association   
                </h2>
            </div>
         </div>
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="parent-teacher-association" class="ms-1 text-sm font-medium text-blue-main"> Parent Teacher Association</a>
                    </div>
                </li>
            </ol>
        </div>
