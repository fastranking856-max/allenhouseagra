...
<head>
    ...
    <title>AllenHouse Agra| Peer Educators Club</title>
</head>
            ...
            <div class="mt-10 relative">
                <div class="absolute top-[-100px] -z-50">
                    <img src="https://res.cloudinary.com/dvzfuapyy/image/upload/v1730307222/Group_53_s3txur.png"
                        class="w-[100%] object-top" alt="Peer Educators Club Banner">
                </div>
                <h1
                ...
                <div class="sm:flex gap-9">
                    <div class="sm:w-[40%]">
                        <img src="assets/images/b4.jpg" alt="Peer Educators Club" class="w-[100%]">
                    </div>
                    <div class="sm:w-[60%]">
                        <h1
                        ...
                        <h3 class="text-gray-600 text-[18px] mt-2 font-[700]">"Guiding Lights"</h3>
                        <p class="sm:text-[18px] text-[16px] text-gray-500 font-[400] mt-3">
                        Allenhouse Public School is dedicated to fostering a supportive, inclusive, and empowering environment where students can share knowledge, develop leadership skills, and contribute positively to the school community. Our mission is to Educate, Enrich, and Empower a network of well-informed individuals who can act as resources and role models for their peers.
                        </p>
                        <p class="sm:text-[18px] text-[16px] text-gray-500 font-[400] mt-3">
                        This club is all about empowering students to uplift one another. We mentor, support, and create safe spaces for both personal and academic growth. Through peer counseling and leadership training, we help shape confident and responsible individuals.
                        </p>
                        <div class="mt-5">
                            <div>
