...
$raw_page = $GLOBALS['api_cache']['fee_structure_data'] ?? [];
...
if (empty($table_html)) {
    $table_html = '<p class="text-center text-gray-500 py-8">Fee structure details will be available soon.</p>';
}
?>
...
<head>
    ...
    <link rel="canonical" href="https://allenhouseagra.com/fee-structure" />
    ...
    <script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 2,
      "name": "Fee Structure",
      "item": "https://allenhouseagra.com/fee-structure"
    }
  ]
}
</script>
