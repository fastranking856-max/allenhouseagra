...
})(window,document,'script','dataLayer','GTM-KCBZ644Q');</script>
</head>
<style>
    #successMessage {
...
<!-- <div id="esuccessPopup" class="relative fixed  bg-green-500 text-white px-4 py-2 rounded mb-5 hidden"
    style="z-index:9999999; position: fixed; right: 0; top: 2%;">
    Form submitted successfully!
</div> -->

<body style="overflow-x: hidden">
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KCBZ644Q"
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
        ...
        <header class="sticky top-0 z-90 lg:px-5 w-[100%] bg-white lg:h-[100px]" style="z-index: 9999;">
            <div class="main-header flex lg:justify-center justify-between px-3 items-center p-[8px]">
                <div class="lg:flex lg:w-[50%]">
                    <img src="assets/images/logo.png" class="lg:w-[200px] w-[150px]" alt="logo">
                </div>
    ...
    <div class="lg:flex">
        <div class="lg:w-[50%] lg:p-10 p-5 lg:pt-[110px] relative z-10">
            <div class="text-center" data-aos="fade-right">
                <h2 class="lg:text-5xl lg:text-4xl xl:text-5xl 2xl:text-5xl text-2xl font-[700] lg:leading-14 inline-flex mb-0 text-white">
                    North Indiaâ€™s Leading Group of Institutions
                </h2>
        ...
        <div class="lg:w-[50%] py-1 relative z-10">
            ...
            <section class="mt-8 py-10 ">
                <div>
                    <div class="text-center">
                        <h2 class="lg:text-3xl text-2xl font-[600] text-[#053B7A]"><?= $advance_data['data'][0]['title'] ?? "" ?></h2>
                    </div>
                ...
                <div class="grid lg:grid-cols-4 md:grid-cols-3 grid-cols-2 lg:p-10 p-4 mt-10 justify-center">
                    <?php
                    ...
                    <!-- <div data-aos="zoom-out-left"
                        class="text-center  lg:border-b-[1px] lg:lg:border-r-[1px] border-[#D3D3D3] pb-5">
                        <div
                            class="lg:h-[90px] lg:w-[90px] h-[75px] w-[75px] rounded-[50%] bg-[#053B7A] flex justify-center items-center mx-auto">
                            <span><img src="assets/images/bulb.png" alt=""></span>
                        </div>
                        <h2 class="lg:text-[18px] text-[16px] mt-3 font-[500]">Creative <br class="lg:hidden block">
                            Co-Curricular</h2>
                    </div>
                    <div data-aos="zoom-out-left"
                        class="text-center lg:border-b-[1px] lg:border-r-[1px] border-[#D3D3D3] pb-5 lg:pt-0 pt-5">
                        <div
                            class="lg:h-[90px] lg:w-[90px] h-[75px] w-[75px] rounded-[50%] bg-[#053B7A] flex justify-center items-center mx-auto">
                            <span><img src="assets/images/bheart.png" alt=""></span>
                        </div>
                        <h2 class="lg:text-[18px] text-[16px] mt-3 font-[500]">Health & Wellness <br
                                class="lg:hidden block"> Empowered</h2>
                    </div>
                    <div data-aos="zoom-out-left"
                        class="text-center lg:border-b-[1px] border-[#D3D3D3] pb-5 lg:pt-0 pt-5">
                        <div
                            class="lg:h-[90px] lg:w-[90px] h-[75px] w-[75px] rounded-[50%] bg-[#053B7A] flex justify-center items-center mx-auto">
                            <span><img src="assets/images/playb.png" alt=""></span>
                        </div>
                        <h2 class="lg:text-[18px] text-[16px] mt-3 font-[500]">Inspiring mdart <br
                                class="lg:hidden block"> Skills for Life</h2>
                    </div>
                    <div data-aos="zoom-out-left"
                        class="text-center lg:border-r-[1px] lg:border-b-[0px] border-[#D3D3D3] pt-5 ">
                        <div
                            class="lg:h-[90px] lg:w-[90px] h-[75px] w-[75px] rounded-[50%] bg-[#053B7A] flex justify-center items-center mx-auto">
                            <span><img
                        ...
                        <h2 class="lg:text-[18px] text-[16px] mt-3 font-[500] lg:mb-0 mb-5">Empathetic Social <br
                    ...
                    <div data-aos="zoom-out-left"
                        ...
                        <h2 class="lg:text-[18px] text-[16px] mt-3 font-[500]">Versatile Tech <br
                                class="lg:hidden block"> Vision</h2>
                    </div>
                    <div data-aos="zoom-out-left" class="text-center lg:border-r-[1px] border-[#D3D3D3] pt-5 ">
                        <div
                            class="lg:h-[90px] lg:w-[90px] h-[75px] w-[75px] rounded-[50%] bg-[#053B7A] flex justify-center items-center mx-auto">
                            <span><img
                        ...
                        <h2 class="lg:text-[18px] text-[16px] mt-3 font-[500]">Excellence in <br
                                class="lg:hidden block"> Communication</h2>
                    </div>
                    <div data-aos="zoom-out-left" class="text-center pt-5">
                        ...
                        <h2 class="lg:text-[18px] text-[16px] mt-3 font-[500]">Robust Sports <br
                                class="lg:hidden block">Program</h2>
                    </div> -->
                </div>
            </section>
            <!--==== END ====-->
                    ...
                    <h2 class="text-[36px] font-[600] text-[#053B7A] lg:hidden block lg:mb-0 mb-5 text-center">About Us
                     ...
                     <div class="relative lg:w-[50%]" data-aos="fade-right" data-aos-offset="300"
                        ...
                        <div id="circleContainer"
                            class="bg-[url('assets/images/achievement-bg.webp')] lg:h-[500px] lg:w-[500px] md:w-[600px] md:h-[600px] w-[300px] h-[300px] rounded-full flex items-center justify-center mx-auto bg-cover">
            ...
            <!--====SHAPING START ====-->
            <section class="lg:mt-20 mt-10 future-skill-bg">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <!-- <div class="swiper-slide p-4 mb-2 bg-white transition-all cursor-pointer hover:translate-y-[-5px]"
                                ...
                                <div data-aos="fade-down" data-aos-easing="linear" data-aos-duration="300">
                                    ...
                                    <div class="bg-white mt-2">
                                        <h2 class="text-[22px] font-[600] text-[#2C4073] lg:leading-6 leading-8">Oluxi
                                            Smart Skills</h2>
                            ...
                            <div class="swiper-slide p-4 mb-2 bg-white transition-all cursor-pointer hover:translate-y-[-5px]"
                                ...
                                <div data-aos="fade-down" data-aos-easing="linear" data-aos-duration="300">
                                    <img src="https://myschool-assets.s3.ap-south-1.amazonaws.com/uploads/OmCxwKlu8Iz6DzDv3mXVxPx78gQWYFr3QKO4oA4c.png"
                                        class="w-[100%]" alt="PG - 1" />
                                    <div class="bg-white mt-2">
                                        <h2 class="text-[22px] font-[600] text-[#2C4073] lg:leading-6 leading-8">
                            ...
                            <div class="swiper-slide p-4 mb-2 bg-white transition-all cursor-pointer hover:translate-y-[-5px]"
                                ...
                                <div data-aos="fade-down" data-aos-easing="linear" data-aos-duration="300">
                                    ...
                                    <div class="bg-white  mt-2">
                                        <h2 class="text-[22px] font-[600] text-[#2C4073] lg:leading-6 leading-8">Social
                                            Emotional Learning
                                        </h2>
                            ...
                            <div class="swiper-slide p-4 mb-2 bg-white transition-all cursor-pointer hover:translate-y-[-5px]"
                                style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;">
                                <div data-aos="fade-down" data-aos-easing="linear" data-aos-duration="300">
                                    <img src="https://myschool-assets.s3.ap-south-1.amazonaws.com/uploads/5UF70SsL7n4caBF71WcAJc57uUEGWCR0RSATEvU3.webp"
                                        class="w-[100%]" alt="PG - 1" />
                                    <div class="bg-white mt-2">
                                        <h2 class="text-[22px] font-[600] text-[#2C4073] lg:leading-6 leading-8">
            ...
            <section class="lg:mt-[90px] mt-10">
                <div class="bg-[#053B7A] relative">
                    <div data-aos="fade-right"
                        class="lg:flex justify-around items-center lg:mx-2 mx-2 lg:text-start text-center lg:py-0 py-4 lg:pt-0 pt-5 lg:py-0 py-10">
                        <div class="mt-[-35px] relative bottom-[-7px]">
                            <img src="assets/images/announce.webp" class="lg:w-[450px] mx-auto  text-center"
                                alt="Announce">
                        </div>
                        <div class="text-white">
                            <h2 class="lg:text-[30px] text-2xl font-[500] lg:leading-12 lg:mt-0 mt-4">Visit Our Campus <br>
                                Experience the
                                Atmosphere</h2>
                        </div>
                ...
                <div class="lg:mx-[100px] mx-[10px] rounded-[20px] lg:p-10 p-3 lg:py-15 py-8">
                    <div class="text-center">
                        <!-- <h2 class="lg:text-4xl text-[24px] font-[600] text-[#053B7A]">
                            ...
                            <span class="inline-flex gap-2 items-center">Allenhouse Public School, Agra</span>
                        </h2>
                    ...
                    <div class="lg:flex flex-wrap grid grid-cols-2 md:grid-cols-3 items-center justify-center gap-10 mx-auto mt-10 lg:w-[1100px] lg:text-[16px] md:text-[13px] text-[12px]">
            ...
            <!-- <section class="bg-cover bg-center relative mt-[60px] allen-achievements overflow-hidden "
                ...
                <div class="lg:w-[1280px] mx-auto p-10 py-20 relative z-90">
                    ...
                    <div class="mt-10 flex  items-center justify-center flex-wrap lg:gap-20 gap-5">
                        <div data-aos="flip-left"
                            class="text-white cursor-pointer transition-all hover:translate-y-[-5px] [6px] border-[1px] border-white p-5 w-[346px]">
                            <div class="flex justify-center items-center w-[80px] h-[80px] bg-red-main rounded-[50%] lg:m-0 mx-auto">
                                <span><img
                                        src="https://myschool-assets.s3.ap-south-1.amazonaws.com/uploads/W40UqpRS5tM9qvdocEGuZvB0a18WP1W0U1IVYt9J.png"
                                        alt=""></span>
                            </div>
                            <h2 class="mt-2 text-[18px] font-[500] text-center lg:text-left">Champions of <br>
                                Harmony Fest</h2>
                        </div>
                        <div data-aos="flip-left"
                            ...
                            <h2 class="mt-2 text-white text-[18px] font-[500] text-center lg:text-left ">Skating Winners of FRS <br>
                        ...
                        <div data-aos="flip-left"
                            ...
                            <h2 class="mt-2 text-white text-[18px] font-[500] text-center lg:text-left">Taekwondo State <br>
                        ...
                        <div data-aos="flip-left"
                            ...
                            <h2 class="mt-2 text-white text-[18px] font-[500] text-center lg:text-left">Awardees of Symphony of <br>
                        ...
                        <div data-aos="flip-left"
                            ...
                            <h2 class="mt-2 text-white text-[18px] font-[500] text-center lg:text-left">KSS English Debate <br>
            ...
            <section class="lg:mt-[60px] mt-8 ">
                ...
                <section class="mt-[60px] ">
                    <div class="lg:mx-[100px] mx-[20px] gap-5">
                        ...
                        <div class="grid lg:grid-cols-5 grid-cols-2 md:grid-cols-3 mt-8 lg:gap-0 gap-10 ">
                ...
                <section class="mt-12 ">
                    <div class="lg:p-10 p-5 lg:w-[1280px] mx-auto">
                        ...
                        <div class="lg:mt-10 mt-5 grid lg:grid-cols-5 grid-cols-2 gap-5">
                            <?php
                            ...
                            <!-- <div data-aos="zoom-out-right" class="rounded-[6px] border-white bg-[#053B7A] p-5 text-center">
                                <div
                                    ...
                                    <span><img
                                            ...
                                            class="lg:w-[45px] w-[30px]" alt=""></span>
                                </div>
  ...
  <script>
    ...
    /* ==============================================================
       NAME FIELD: 50 CHARS + LETTERS ONLY â†’ BOTH ERRORS WORK
       ============================================================== */
