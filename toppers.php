...
<head>
    ...
    <title>AllenHouse Agra| Toppers</title>
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="toppers" class="ms-1 text-xs sm:text-sm font-medium text-blue-main">Toppers</a>
                        </div>
                    </li>
                </ol>
            </div>
                                ...
                                async function fetchAchievements() {
                                    try {
                                        const response = await fetch(
                                            "https://allenhouseadmin.fastranking.tech/api/achievements/1"
                                            );
