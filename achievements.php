...
<head>
    ...
    <link rel="canonical" href="https://allenhouseagra.com/achievements" />
    <title>Student Achievements | AllenHouse Agra</title>
    <?php include "includes/head.php" ?>

    <style>
        .active-tab {
            background-color: #223B71 !important; /* Agra Primary Blue */
    ...
    <script>
        ...
        async function loadAgraAchievements() {
            try {
                ...
                console.error("Error loading Agra Achievements:", error);
            }
        }
